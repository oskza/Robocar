...
void WheelOutputController::begin(uint8_t acceleration) {
...
void WheelOutputController::setAcceleration(uint8_t acceleration) { _acceleration = constrain(acceleration, 1, MotorDriver::MAX_OUTPUT); }
