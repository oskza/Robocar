...
#include "writer/RobotSnapshotJsonWriter.h"
#include "writer/SystemSnapshotJsonWriter.h"
#include "writer/PowerSnapshotJsonWriter.h"
#include "writer/MotionSnapshotJsonWriter.h"
#include "writer/WifiSnapshotJsonWriter.h"
#include "writer/RobotConfigJsonWriter.h"
#include "writer/MotionConfigJsonWriter.h"
#include "writer/WifiConfigJsonWriter.h"
#include "writer/WifiCredentialsJsonWriter.h"
...
const char *CommandJsonSerializer::_typeToString(CommandResponseType type) {
    switch (type) {
        ...
        case CommandResponseType::POWER_STATUS: return "powerStatus";
...
bool CommandJsonSerializer::serialize(
    ...
    switch (response.type) {
        ...
        case CommandResponseType::POWER_STATUS:
            PowerSnapshotJsonWriter::write(payload, response.payload.power);
            break;
